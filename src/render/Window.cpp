...
void Window::enableRelativeMouseMode() const
{
    SDL_SetRelativeMouseMode(SDL_TRUE);
}
void Window::disableRelativeMouseMode() const
{
    SDL_SetRelativeMouseMode(SDL_FALSE);
}

void Window::clear(float red, float blue, float green, float alpha) const
{
