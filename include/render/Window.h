...
class Window
{
    public:
        ...
        void clear(float red, float blue, float green, float alpha) const;
        // Update window rendering by changing buffers
        void swapBuffers() const;

        // Enable and Disable Relative Mouse mode on SDL
        void enableRelativeMouseMode() const;
        void disableRelativeMouseMode() const;
